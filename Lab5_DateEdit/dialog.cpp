...
void Dialog::on_btn_hesapla_clicked()
{
    ...
    if(yas > 40)
    {
            ...
            {
                QMessageBox::information(this, "VKI Sonuç", "<font color='#ff0000'>VKI:İleri Derecede Obez, Yaşa Dikkat Edilmeli</font>", "Tamam");
            }
    }
    ...
    else
    {
            ...
            {
                QMessageBox::information(this, "VKI Sonuç", "<font color='#ff0000'>İleri Derecede Obez</font>", "Tamam");
            }
    }
